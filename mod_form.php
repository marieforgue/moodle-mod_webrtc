...
class mod_webrtc_mod_form extends moodleform_mod {
    ...
    public function definition() {
		...
		$mform->addElement('text', 'flux', get_string('flux', 'webrtc'), array('size'=>'40', 'maxsize'=>'200'));
		$mform->setType('flux', PARAM_TEXT);
		$mform->setDefault('flux', 'ws://adress:port');
		$mform->addRule('flux', null, 'required', null, 'client');
